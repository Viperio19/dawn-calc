...
function calculateBWXY(gen, attacker, defender, move, field) {
    ...
    var type1Effectiveness = (0, util_2.getMoveEffectiveness)(gen, move, defender.types[0], field, isGhostRevealed, field.isGravity);
    var type2Effectiveness = defender.types[1]
        ? (0, util_2.getMoveEffectiveness)(gen, move, defender.types[1], field, isGhostRevealed, field.isGravity)
        : 1;
