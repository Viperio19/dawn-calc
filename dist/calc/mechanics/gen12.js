...
function calculateRBYGSC(gen, attacker, defender, move, field) {
    ...
    var type1Effectiveness = (0, util_1.getMoveEffectiveness)(gen, move, firstDefenderType, field, field.defenderSide.isForesight);
    var type2Effectiveness = secondDefenderType
        ? (0, util_1.getMoveEffectiveness)(gen, move, secondDefenderType, field, field.defenderSide.isForesight)
        : 1;
