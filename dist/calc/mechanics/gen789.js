...
function calculateSMSSSV(gen, attacker, defender, move, field) {
    ...
    if (defender.hasAbility('Tera Shell') &&
        ...
        (!field.defenderSide.isSR && (!field.defenderSide.spikes || defender.hasType('Flying') || defender.hasInvisisbleType(attacker, field, 'Flying')) ||
...
function calculateDefenseSMSSSV(gen, attacker, defender, move, field, desc, isCritical) {
    ...
    if (field.hasWeather('Snow') && (defender.hasType('Ice') || defender.hasInvisisbleType(attacker, field, 'Ice')) && hitsPhysical) {
        defense = (0, util_2.pokeRound)((defense * 3) / 2);
        desc.weather = field.weather;
    }
