...
const CHROMATIC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  Gothitelle: {otherFormes: ['Gothitelle-Crest']},
  ...
  Reuniclus: {otherFormes: ['Reuniclus-Crest']},
  ...
  Sawsbuck: {otherFormes: ['Sawsbuck-Crest-Spring', 'Sawsbuck-Crest-Summer', 'Sawsbuck-Crest-Autumn', 'Sawsbuck-Crest-Winter']},
