...
const CHROMATIC_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  ...
  'Bronzong-Aevian': {
    ...
    weightkg: 187,
    abilities: {0: 'Reflector'}, // Aevian Forms - TODO: Implement Ability
  ...
  'Hakamo-o-Aevian': {
    ...
    weightkg: 47,
    abilities: {0: 'Inexorable'}, // Aevian Forms - TODO: Implement Ability
  ...
  'Paras-Aevian-Z': {
    ...
    weightkg: 4.2,
    abilities: {0: 'Resuscitation'}, // Aevian Forms - TODO: Implement Ability
    baseSpecies: 'Paras',
    nfe: true,
  },
  'Paras-Aevian': {
  ...
  'Parasect-Aevian-Z': { // Zombie stuff
    types: ['Ghost', 'Poison'],
